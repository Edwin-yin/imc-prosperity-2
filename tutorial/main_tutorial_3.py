...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        if "RAINFOREST_RESIN" in state.order_depths:
            ...
            print(state)
            RAINFOREST_RESIN_orders = self.RAINFOREST_RESIN_orders(state.order_depths["RAINFOREST_RESIN"], RAINFOREST_RESIN_fair_value, RAINFOREST_RESIN_width, RAINFOREST_RESIN_position, RAINFOREST_RESIN_limit)
